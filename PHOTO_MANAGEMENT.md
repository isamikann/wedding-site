...
- **連番**: `1.jpg`, `2.jpg`, `3.jpg`, ... （無制限）
- **photo連番**: `photo1.jpg`, `photo2.jpg`, ... （無制限）
- **IMG連番**: `IMG_0001.jpg`, `IMG_0002.jpg`, ... （無制限）
...
- ファイルが連続して3回見つからなくなったら検索終了
- 実際に存在するファイルのみを表示
- ファイル数に制限なし（ただし100枚まで推奨）

### ⚠️ 注意事項

- ファイル名は上記のパターンに従ってください
- カスタムファイル名（例: `beach_sunset.jpg`）は現在未対応です
- 連番は1から開始し、飛ばさないでください（例: 1,2,4ではなく1,2,3）
